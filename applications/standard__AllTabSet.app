...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <tab>Copy_History</tab>
    <tab>standard-WorkBadge</tab>
    <tab>Dataflow_Editor</tab>
    <tab>Sales_Wave_Quotas</tab>
    <tab>standard-LiveAgentSupervisor</tab>
    <tab>Chatter_Story__c</tab>
    <tab>Wave_Data_Generator</tab>
    ...
    <tab>accHierarchy__Account_Hierarchy_Setup</tab>
